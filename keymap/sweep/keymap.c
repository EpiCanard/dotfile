...
// ,--------------------------------------------.    ,--------------------------------------------.
     FR_EXLM, FR_AT  , FR_LCBR, FR_RCBR, FR_PIPE,      _______, _______, _______, _______, FR_ASTR,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     FR_HASH, FR_DLR , FR_LPRN, FR_RPRN, _______,       KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, FR_PLUS,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     FR_PERC, FR_CIRC, FR_LBRC, FR_RBRC, FR_TILD,      FR_AMPR, _______, _______, _______, FR_BSLS,
// `--------------------------------------------'    `--------------------------------------------'
...
// ,--------------------------------------------.    ,--------------------------------------------.
     _______, KC_BRIU, _______, _______, _______,      _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     KC_CAPS, KC_BRID, _______, _______, _______,      KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
