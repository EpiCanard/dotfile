...
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     SFT_A  , GUI_S  , ALT_D  , LT2_F  , FR_G   ,      FR_COLN, LT2_H   , ALT_J  , GUI_K , SFT_L  ,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
...
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     KC_LSFT, FR_DLR , FR_LPRN, FR_RPRN, FR_HASH,      _______, KC_LEFT, KC_DOWN, KC_UP  , SFT_RGT,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
...
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
     KC_LSFT, KC_ACL1, KC_ACL2, _______, _______,      _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
// |--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------|
