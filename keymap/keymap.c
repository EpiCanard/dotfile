...
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     _______, FR_Q   , FR_W   , FR_E   , FR_R   , FR_T   , _______,      _______, FR_Y   , FR_U   , FR_I   , FR_O   , FR_P   , FR_BSLS,
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     TT(2)  , FR_A   , FR_S   , FR_D   , LT2_F  , LT1_G  ,                        FR_H   , FR_J   , FR_K   , FR_L   , LT2_COL, FR_QUOT,
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     KC_LSFT, FR_Z   , FR_X   , FR_C   , FR_V   , LT3_B  , C(FR_B),      C(FR_B), FR_N   , LT1_M  , FR_COMM, FR_DOT , FR_SLSH, FR_GRV ,
// |--------+-----------------+--------+--------+--------+--------'    `--------+--------+--------+--------+--------+--------+--------|
     KC_LCTL, KC_LGUI, KC_LALT, _______, KC_ESC ,                                          TD_LCTL, _______, _______, _______, TT(1)  ,
// `--------------------------------------------'                                        `--------------------------------------------'
