...
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     TT(2)  , FR_A   , FR_S   , FR_D   , LT2_F  , LT1_G  ,                        FR_H   , FR_J   , FR_K   , FR_L   , CS_COLN, CS_QUOT,
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     KC_LSFT, LCTL_Z , FR_X   , FR_C   , FR_V   , FR_B   , OSL(3) ,      OSL(3) , FR_N   , FR_M   , CS_COMM, CS_DOT , CS_SLSH, TT(2)  ,
// |--------+-----------------+--------+--------+--------+--------'    `--------+--------+--------+--------+--------+--------+--------|
     LT4_GRV, KC_LGUI, KC_LALT, _______, _______,                                          _______, _______, _______, _______, TT(1)  ,
// `--------------------------------------------'                                        `--------------------------------------------'
