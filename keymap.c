...
#define LT_1_G LT(1, FR_G)
#define CSG_NO C(S(G(KC_NO)))

enum custom_keycodes {
    PM_SCRL = CS_SAFE_RANGE,
    PM_FACT
};
...
// ,------------------------------------------------------------------------.    ,--------------------------------------------------------------.
     KC_ESC      , FR_EXLM     , FR_AT  , FR_HASH, FR_DLR , FR_PERC, TT(4)  ,      FR_CIRC, FR_AMPR, FR_ASTR, FR_LPRN, FR_RPRN, CS_MINS, FR_EQL ,
// |-------------+-------------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     KC_DEL      , FR_Q        , FR_W   , FR_E   , FR_R   , FR_T   , PM_FACT,      C(KC_Z), FR_Y   , FR_U   , FR_I   , FR_O   , FR_P   , CS_BSLS,
// |-------------+-------------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     TT(2)       , FR_A        , FR_S   , FR_D   , FR_F   , LT_1_G ,                        FR_H   , FR_J   , FR_K   , FR_L   , CS_COLN, CS_QUOT,
// |-------------+-------------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     KC_LSFT     , LCTL_T(FR_Z), FR_X   , FR_C   , FR_V   , FR_B   , OSL(3) ,      OSL(3) , FR_N   , FR_M   , CS_COMM, CS_DOT , CS_SLSH, TT(2)  ,
// |-------------+-------------+--------+--------+--------+--------+--------'    `--------+--------+--------+--------+--------+--------+--------|
     LT(4,FR_GRV), KC_LGUI     , KC_LALT, KC_BTN2, KC_BTN1,                                          KC_DOWN, KC_UP  , _______, KC_BTN3, TT(1)  ,
// `------------------------------------------------------'                                        `--------------------------------------------'
...
//                                               ,--------+--------+--------|    |--------+--------+--------.
                                                                     KC_END ,      TT(1)  ,
//                                               |        |        |--------|    |--------|        |        |
                                                   KC_SPC , KC_TAB , PM_SCRL,      _______, KC_ENT , CS_BSPC
//                                               `--------------------------'    `--------------------------'
),
...
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
     _______, FR_EXLM, FR_AT  , FR_LCBR, FR_RCBR, FR_PIPE, _______,      _______, KC_UP  , FR_GRV , _______, _______, FR_ASTR, _______,
// |--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+--------+--------+--------+--------|
...
// |--------+--------+------------+------------+------------+--------+--------|    |--------+--------+--------+--------+------------+--------+--------|
     _______, _______, CS_EGRV    , CS_EACU    , XP(EC, ECM), _______, _______,      _______, _______, CS_UGRV, _______, XP(OC, OCM), _______, _______,
// |--------+--------+------------+------------+------------+--------+--------|    |--------+--------+--------+--------+------------+--------+--------|
     _______, CS_AGRV, XP(AC, ACM), XP(AR, ARM), _______    , _______,                        _______, _______, _______, _______    , _______, _______,
// |--------+--------+------------+------------+------------+--------+--------|    |--------+--------+--------+--------+------------+--------+--------|
     _______, _______, _______    , CS_CCED    , _______    , _______, _______,      _______, _______, _______, _______, _______    , _______, _______,
// |--------+--------+------------+------------+------------+--------+--------'    `--------+--------+--------+--------+------------+--------+--------|
